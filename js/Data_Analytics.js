...
const quizData = [
    ...
    },
    {
        ...
        options: [
            ...
            "Mean is the average : median is middle value.", 
            "Both represnt the average", 
            "Mean and median are used inerchangeably"
        ],
    ...
    },
    {
        ...
        options: [
                    "The most common value in a database ", 
                    "Unusual or extreme value in a databse", 
                    "The diffrence between mean and median", 
                    "The last valu in a sortd dataset"
                ],
    ...
    },
    {
        ...
        options: [
                "The diffrence between the blargest and smallest values",   
                "The sum of all values", "The product od all value", 
    ...
    },
    {
        ...
        options: [
                    "Causation between variable", 
                    "Descibing the spread of data", 
                    "Measuring the strengeth and direction of a linear relationship", 
                    "Identify outlier"
                ],
    ...
    },
    {
        ...
        options: [
            "The symmetry od a distribution", 
            "The spread of data", 
    ...
    },
    {
        ...
        options: [
            "Measurig central tendency", 
            "Describing the spread or dispersion of data", 
            "Identifying the most frequen value", 
            "Represnting the range value"
        ],
    ...
    },
    {
        ...
        options: [
            "Reprenting the distribution of a single variable", 
            "Showng the realtion between two variable", 
            "Identifying outliers and displaying the spread of data", 
            "Displaying hirarchical realtionships"
        ],
    ...
    },
    {
        ...
        options: [
            "Descrining the central tendency of data ", 
            "Identifying outliers", 
            "Making predictions", 
            "Drawing inference about population based on sample data"
            ],
    ...
    },
    {
        ...
        options: [
            "Identifing outlier in a dataset", 
            "Assessing the spread of data", 
            "Evaluation thr correlation between predircetion variables", 
            "Handling missing values i regression models"
        ],
    ...
    },
    {
        ...
        options: [
            ...
            "Combining prediction from multiple models", 
            "Handeling outlier by giving less weight to extreme values", 
    ...
    },
    {
        ...
        options: [
            "The range of valu witin which a population parameter is estimated to lie", 
            "The average of sample values", 
            "The proportion of data falling within a specifed range", 
    ...
    },
    {
        ...
        options: [
            "Assessing multicollonearity in regression model", 
            "Evaluating the distribution of residuals", 
            "Summarizing the performance od a classification model ", 
            "Identifying outlier in a dataset"
        ],
